...
function cannotDecode() {
  decoded.innerHTML = "Couldn't decode<br>Syntax: append .mtmi.eu after a ha.mr URL to get it's destination for example<br>http://ha.mr#OM( -> http://ha.mr.mtmi.eu#OM(";
